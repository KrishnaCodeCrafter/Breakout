//cd /Users/iquit/Desktop/Breakout && find src/main -name "*.java" > sources.txt && javac -cp ".:mysql-connector-j-9.3.0.jar" @sources.txt && java -cp ".:mysql-connector-j-9.3.0.jar:src" main.Main
